    ...
    return (
        <main className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
            ...
            <div className="container mx-auto px-4 py-8 max-w-2xl">
                ...
                {/* Recently Added — moved above Browse by Category */}
                ...
                {/* Contact Actions — premium black + orange */}
                <div className="grid grid-cols-2 gap-3 mb-8">
                    <a
                        href={whatsappUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-center gap-2 bg-gray-900 hover:bg-black text-orange-500 font-semibold py-3.5 px-4 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-800"
                    >
