            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
                    ...
                    <div className="flex items-end gap-2">
                        ...
                        <Link href="/admin/leads" className="text-[10px] text-yellow-600 font-semibold mb-1 hover:underline">View all →</Link>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
                    ...
                    <div className="flex items-end gap-2">
                        ...
                        <Link href="/admin/verification-forms" className="text-[10px] text-yellow-600 font-semibold mb-1 hover:underline">Verify now →</Link>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-[2rem] shadow-sm border border-gray-100 dark:border-gray-700 p-6 mb-8">
                ...
                <div className="flex flex-wrap gap-3">
                    <Link
                        ...
                        className="flex items-center gap-2 px-6 py-3 bg-yellow-600 hover:bg-yellow-700 text-white font-semibold rounded-xl transition-colors"
                    >
