                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex flex-col gap-2">
                                                <button
                                                    ...
                                                    className={`px-3 py-1 text-[10px] font-bold rounded-full w-fit uppercase tracking-wider ${property.isPublished
                                                ...
                                                <button
                                                    ...
                                                    className={`px-3 py-1 text-[10px] font-bold rounded-full w-fit uppercase tracking-wider ${property.isSold
                                                        ? 'bg-orange-100 dark:bg-orange-900 text-orange-700 dark:text-orange-300 border border-orange-200'
